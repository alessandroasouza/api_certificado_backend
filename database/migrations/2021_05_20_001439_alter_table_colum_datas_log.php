...
class AlterTableColumDatasLog extends Migration
{
    ...
    public function up()
    {
        Schema::table('inscricao', function (Blueprint $table) {
           ...
           $table->dateTime('data_chamada1')->nullable()->default(null);
           $table->dateTime('data_chamada2')->nullable()->default(null);
           $table->dateTime('data_presenca1')->nullable()->default(null);
           $table->dateTime('data_presenca2')->nullable()->default(null);
        });
    }
